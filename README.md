...
Kuberhealthy's AMI Check

## What it is
This repository builds the container image used by Kuberhealthy to run the ami-check check.

## Image
- `docker.io/kuberhealthy/ami-check`
- `ghcr.io/kuberhealthy/ami-check`
...
## Build locally
- `docker build -f ./Containerfile -t kuberhealthy/ami-check:dev .`
